        ...
        <section>
          <div className="flex items-center justify-between mb-8 bg-gradient-to-r from-[var(--color-accent-bg)] to-transparent p-6 rounded-[24px] border-l-8 border-[var(--color-accent)] shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="font-snasm text-[28px] text-[var(--color-text-heading)] tracking-tight">Recommended for You</h2>
                <p className="text-[13px] font-black text-[var(--color-primary)] uppercase tracking-[0.2em] opacity-70">Curated just for you</p>
              </div>
            </div>
            <Link to="/explore">
